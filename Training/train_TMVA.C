...
void train_TMVA(const char* infile, const char* outfile, int Target_type = 0, int Training_type = 0, int jet_type = 0)
{
  ...
  TString opts = "NTrees=500:MaxDepth=5:nCuts=500:BoostType=Grad:!UseBaggedGrad";
  opts += ":Shrinkage=0.1:MinNodeSize=1";
  opts += ":PruneStrength=5:PruneMethod=CostComplexity";
